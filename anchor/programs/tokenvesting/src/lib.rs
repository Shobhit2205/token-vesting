...
declare_id!("2BVt91uognd18H4szQHtqtKfRkQmedrjBY5u8L3vmChp");
...
pub mod tokenvesting {
    ...
    pub fn claim_tokens(ctx: Context<ClaimTokens>, _company_name: String) -> Result<()> {
      ...
      let cpi_context = CpiContext::new(cpi_program, transfer_cpi_account).with_signer(signer_seed);
...
pub enum ErrorCode {
  ...
  #[msg("Invalid Vesting Period, Vesting Period should be greater than 0")]
  InvalidVestingPeriod,
  #[msg("Calculation Overflow!")]
  CalculationOverflow,
  #[msg("No amount is present to be claimed")]
  NothingToClaim,
}